...
public class JobsFragment extends Fragment {
    ...
    private void init() {
        ...
        jobsList.add(new Job("image", "TITLE 1",R.drawable.img1));
        jobsList.add(new Job("image", "TITLE 2",R.drawable.img2));
        jobsList.add(new Job("image", "TITLE 3",R.drawable.img3));
        jobsList.add(new Job("image", "TITLE 4",R.drawable.img4));
        jobsList.add(new Job("image", "TITLE 5",R.drawable.img5));
        jobsList.add(new Job("image", "TITLE 6",R.drawable.img6));
        jobsList.add(new Job("image", "TITLE 7",R.drawable.img7));
        jobsList.add(new Job("image", "TITLE 8",R.drawable.img8));
